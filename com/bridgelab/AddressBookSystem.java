...
public class AddressBookSystem {
	/**
	 * create a arraylist object name as contactList Store the person all details in
	 * object
	 */
	public static ArrayList<Contacts> contactList = new ArrayList<>();

	/**
	 * create a object for map,object name is nameHashMap store persons name in this
	 * object
	 */
	public static Map<String, Contacts> nameHashMap = new HashMap<String, Contacts>();
	/**
	 * create a object for map,object name is nameHashMap store the city of person
	 * in this object
	 */
	public static Map<String, Contacts> cityHashMap = new HashMap<String, Contacts>();
	/**
	 * create a object for map,object name is StateHashMap store the State of person
	 * in this object
	 */
	public static Map<String, Contacts> stateHashMap = new HashMap<String, Contacts>();
	/**
	 * creating scanner class object scanner class used to taking input form user
	 */
	...
	/**
	 * create a method name as addContact,this is parameterized method this method
	 * is boolean type that means their output is true or false
	 * 
	...
	public List<Contacts> searchByName(String name) {
		/**
		 * collection list of element stream and lambda for find filter given name from
		 * arraylist
		 */
	...
	/**
	 * create a method name as searchByCity in this method we search the pesron is
	 * their city name
	 * 
	 * @param city person
	 * @return person
	...
	public List<Contacts> searchByCity(String city) {
		/**
		 * collection list of element stream and lambda for find filter given city from
		 * arraylist
		 */
	...
	/**
	 * create a method name as searchByState in this method we search the person is
	 * their State name
	 * 
	 * @param state person
	 * @return person
	...
	public List<Contacts> searchByState(String state) {
		/**
		 * collection list of element stream and lambda for find filter given State from
		 * arraylist
		 */
	...
	public static List<Contacts> sortBy(Function<? super Contacts, ? extends String> key) {
		/**
		 * in contactList sorted the data and comapring with key and collect to the
		 * previous result in list
		 */
	...
	public String toString() {
		...
		/**
		 * using for loop check the condition and search the contactList in specific
	...
	/**
	 * create a method name as readContact method for adding details
	 * 
	 * @return firstName,lastName,email,phoneNumber,City,Address,Zip,State
	 */
	public static Contacts readContact() {
		/**
		 * create a scanner class object scanner is used for geeting input from user
		 */
	...
	/**
	 * create a method name as addressBookOptions method for show option for
	 * contacts
	 * 
		...
		while (true) {
			...
			case 1:
				...
				if (addressBook.addContact(readContact()))
					/**
					 * create a new contact check in address book this contact duplicate or not they
					 * are not duplicate then display this msg
					 */
	...
	/**
	 * create a method name as viewByOption this is parameterized method. this
	...
	/**
	 * create a method name as countByOption this method to count element by option
	 */
	public void countByOption() {
		...
		case 1:
			/**
			 * Map<String, Long> countCity – this is the output result Map that will store
			 * the grouped elements as keys and count their occurrences as values,
			 * contactList.stream() – we convert the contactlist elements into Java stream
			 * to process the collection in a declarative way Collectors.groupingBy() – this
			 * is the method of Collectors class to group objects by some property and store
			 * results in a Map instance Collectors.counting() – this Collectors class
			 * method counts the number of elements passed in the stream as a parameter
			 */
